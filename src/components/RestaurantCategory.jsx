...
const RestaurantCategory = ({data, showItems, setShowIndex, unsetShowIndex, restaurant, highlightedDishId}) => {
    ...
    return (
        <div className="mx-3 my-3 rounded-xl border border-gray-200 bg-white px-4 py-2 shadow-sm">
            {/*
            ...
            */}
            ...
            >
                ...
                <span
                    aria-hidden="true"
                    className={`inline-block flex-shrink-0 text-2xl leading-none text-gray-700 transition-transform duration-200 ${showItems ? 'rotate-180' : ''}`}
                >
                    &#9662;
                </span>
            </button>
