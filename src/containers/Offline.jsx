  ...
  return (
    ...
    >
      <div className="flex h-14 w-14 items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800">
        <FiWifiOff className="text-gray-600 dark:text-gray-400" size={26} aria-hidden="true" />
      </div>

      <h1 className="mt-5 text-2xl font-bold text-gray-900 dark:text-gray-100 sm:text-3xl">
